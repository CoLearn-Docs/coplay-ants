...
class GStreamer():
	...
	def mime_set(self):
		...
		# self.mime = f"video/h264;codecs=avc1.42E03C;width={self.width};height={self.height};framerate={self.framerate};bitrate={self.bitrate}"
		self.mime = f"video/h264;codecs=avc1.42E03C;width={self.width};height={self.height}"
